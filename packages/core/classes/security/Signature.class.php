...
class Signature extends Model {
    ...
    private static function computeSignatureValidation($data_digest, $sig_algo_oid, $sig_hash, $sig_cert) {
        ...
        // Here, for verification, we use openssl_public_decrypt as if the hash of the original data (entire document) had been generated by the signature algorithm.
        // This is only the case for RSA PKCS#1 v1.5 signatures with SHA-256, since we pre-compute the Digest of the document as a SHA-256 hash.
