...
list($params, $providers) = eQual::announce([
    'description' => 'Import data from a database to eQual database for a given package, needs a configuration file init/import-config.json in folder of given package.',
    'params'      => [
        'db_dbms' => [
            'type'    => 'string',
            'default' => 'MYSQL'
...
function castOldDbRow(array $old_item, array $old_table_fields_config): array {
    $old_item_casted = [];
...
function createNewItemFromOld(array $config, DBManipulator $old_db_connection, array $old_item): array {
    $item = [
