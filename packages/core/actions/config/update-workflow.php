...
$nodeGetColumns = $nodeFinder->findFirst($ast_temp, function(Node $node) {return $node->name->name === "getWorkflow";});

// Add a visitor hijack the getWorkflow method and update its content with new schema
$traverser->addVisitor(
        new class($nodeGetColumns, "getWorkflow") extends NodeVisitorAbstract {
            private $node;
            private $target;
