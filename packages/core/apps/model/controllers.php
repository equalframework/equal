...
$html->addCSSFile('workbench/assets/css/jquery-ui.min.css');
$html->addCSSFile('workbench/assets/css/bootstrap.css');

$html->addJSFile('workbench/assets/js/jquery.min.js');
$html->addJSFile('workbench/assets/js/jquery-ui.min.js');



$json = run('get', 'core_config_controllers', ['package' => $params['package']]);
