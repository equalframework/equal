...
Setting::assert_value('core', 'units', 'length', 'm');
Setting::assert_value('core', 'units', 'weight', 'kg');
Setting::assert_value('core', 'units', 'volume', 'm3');
Setting::assert_value('core', 'units', 'surface', 'm2');
