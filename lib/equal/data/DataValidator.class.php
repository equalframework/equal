...
class DataValidator extends Service {
     ...
     *
     * getConstraintFromUsage('language/iso-639')['rule']('fr');        // true
     * getConstraintFromUsage('language/iso-639')['rule']('fr-CA');     // true
     * getConstraintFromUsage('language/iso-639')['rule']('en-GB');     // true
     * getConstraintFromUsage('language/iso-639')['rule']('en-US');     // true
     * getConstraintFromUsage('language/iso-639')['rule']('fr-');       // false
     * getConstraintFromUsage('language/iso-639')['rule']('en-en');     // false
     * getConstraintFromUsage('language/iso-639')['rule']('en-EN');     // false
     *
