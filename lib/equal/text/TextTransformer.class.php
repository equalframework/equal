...
class TextTransformer {
    ...
    public static function toAscii($value) {
        ...
        static $map_ascii = [
            ...
            'Ğ'=>'G', 'Ģ'=>'G',
            'Í'=>'I', 'Ì'=>'I', 'Î'=>'I', 'Ï'=>'I', 'Ĩ'=>'I', 'Ī'=>'I', 'İ'=>'I',
            'Ł'=>'L',
            'Ó'=>'O', 'Ò'=>'O', 'Ô'=>'O', 'Ö'=>'O', 'Õ'=>'O', 'Ō'=>'O', 'Ő' => 'O',
            'Ŕ'=>'R',
            'Ú'=>'U', 'Ù'=>'U', 'Û'=>'U', 'Ü'=>'U', 'Ũ'=>'U', 'Ū'=>'U', 'Ű' => 'U',
            'Ý'=>'Y', 'Ỳ'=>'Y', 'Ŷ'=>'Y', 'Ÿ'=>'Y', 'Ỹ'=>'Y', 'Ȳ'=>'Y',
            'Æ'=>'AE', 'Þ'=>'Th', 'Ç'=>'C', 'Ð'=>'D', 'Ƒ'=>'F', 'Ñ'=>'N', 'Ń'=>'N', 'Œ'=>'OE', 'Ø'=>'O', 'ß'=>'ss', 'Š'=>'S', 'Ș'=>'S', 'Ț'=>'T', 'Ž'=>'Z',
            // lower case chars
            ...
            'ğ'=>'g', 'ģ'=>'g',
            'í'=>'i', 'ì'=>'i', 'î'=>'i', 'ï'=>'i', 'ĩ'=>'i', 'ī'=>'i', 'ı'=>'i',
            'ł'=>'l',
            'ó'=>'o', 'ò'=>'o', 'ô'=>'o', 'ö'=>'o', 'õ'=>'o', 'ō'=>'o', 'ő'=>'o',
            'ŕ'=>'r',
            'ú'=>'u', 'ù'=>'u', 'û'=>'u', 'ü'=>'u', 'ũ'=>'u', 'ū'=>'u', 'ű'=>'u',
            'ý'=>'y', 'ỳ'=>'y', 'ŷ'=>'y', 'ÿ'=>'y', 'ỹ'=>'y', 'ȳ'=>'y',
            'æ'=>'ae', 'þ'=>'th', 'ç'=>'c', 'ð'=>'d', 'ƒ'=>'f', 'ñ'=>'n', 'ń'=>'n', 'œ'=>'oe', 'ø'=>'o', 'š'=>'s', 'ș'=>'s', 'ț'=>'t', 'ž'=>'z'
        ];
