...
// needed to adjust this : fake one-to-many with rel_table                
    ...
    (function fetchConfig() {
        ...
        $http({
            method: 'GET',
            url: qinoa.config.url+'?get=core_config_classes&package='+qinoa.config.model
        })
        .then(
            function success(response) {
                ...
                angular.forEach(response.data, function(classname) {
                    ...
                    promises.push($http({
                        method: 'GET',
                        url: '/index.php?get=core_model_schema&entity='+entity
                    }).then(
                        function success(response) {
                    ...
                    for(var type of types) {
                        promises.push($http({
                            method: 'GET',
                            url: '/index.php?get=core_model_view&entity='+entity+'&context='+type
                        }).then(
                            function success(response) {
                ...
                RestangularProvider.addFullRequestInterceptor(function(element, operation, what, url, headers, params) {
                    ...
                    switch(operation) {
                        ...
                        case 'put':
                            ...
                            params.operation = 'do=core_model_update';
                            params.id = url.substr(url.lastIndexOf('/') + 1);                            
                            break;
                        case 'remove':
                            params.operation = 'do=core_model_delete';
                            params.id = url.substr(url.lastIndexOf('/') + 1);                            
                            break;
