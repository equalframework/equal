...
**1. Layout** : This is the part that vary the most. The [layout](../../equal-ui/views/views.md#layout) is the part of the view that will display the object of a Model.

**2. Header** : Refers to the [header part](../../equal-ui/views/views.md#header) of a view. You can edit header actions and selection actions in this tab.

**3. Actions** : You can edit the custom [actions](../../equal-ui/views/views.md#actions) of the view here
...
**4.** Give you all the **custom [routes](../../core-development/controllers-routing/routing.md)** enabled in the instance that uses this controller.
...
All the editable properties of the view in workbench are properties findable in the [original menu structure](../../equal-ui/menus.md).
