...
- **Capabilities:** Define which generic CRUD operations are structurally exposed by an entity before ACLs and business rules are evaluated. See [Entity Capabilities](../entities-persistence/entities.md#capabilities).
