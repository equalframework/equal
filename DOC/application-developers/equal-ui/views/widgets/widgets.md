...
| `usage`      | `string`  | Overrides the field's [usage](../../../core-development/entities-persistence/fields.md#usages) to change display formatting                            |
...
For a complete list of available usages, refer to [content-type specifications](../../../core-development/entities-persistence/fields.md#common-usages).
