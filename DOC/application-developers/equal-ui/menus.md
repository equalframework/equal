...
The `context` object determines the state of the application upon navigation. It links the menu item to a specific [Entity](../core-development/entities-persistence/entities.md).

| Property | Type     | Description                                                                                                    |
| :------- | :------- | :------------------------------------------------------------------------------------------------------------- |
| `entity` | `string` | The fully qualified name of the [Entity](../core-development/entities-persistence/entities.md) to display (e.g., `core\User`, `lodging\sale\booking\Booking`). |
| `view`   | `string` | The ID of the [View](./views/views.md) to render (e.g., `list.default` => it will always be: `[type].[name]`).             |
| `domain` | `array`  | (Optional) A [Domain](../core-development/data-rules-processing/domains.md) array defining filters to apply to the data (e.g., `[['status', '=', 'active']]`). |
