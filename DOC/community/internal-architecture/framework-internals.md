...
A **domain** is a structured array that defines filter criteria for objects, used in searches, permissions, view visibility, and more. Domains are composed of **clauses** and **conditions**. More on that in the [Domain documentation](../../application-developers/core-development/data-rules-processing/domains.md).
